...
/opt/cloudstack/scripts/storage/secondary/cloud-install-sys-tmplt -m /export/secondary -u http://jenkins.buildacloud.org/view/4.3/job/cloudstack-4.3-systemvm/lastSuccessfulBuild/artifact/tools/appliance/dist/systemvmtemplate-2014-02-04-master-xen.vhd.bz2 -h xenserver -F -o         "localhost" -r root
